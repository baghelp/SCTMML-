...
public:
   ...
   */
  LengthControllerYAML(double startTime, double minTension, double rate,
			    double angle);
...
protected:
   ...
   */
  void initializeActuators( TensegrityModel& subject );
...
private:
  ...
  std::string const CABLES[12] = {"cube_string_1", "cube_string_2",
  ...
  std::string const RODS[6] = {"rod_1", "rod_2", "rod_3", "rod_4", "rod_5", "rod_6"};
